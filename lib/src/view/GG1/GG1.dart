          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    myHomeScreenController.gg1List.clear();
                    myHomeScreenController. update();
                    myHomeScreenController.GG1(
                        ...
                        averageServiceTime: int.parse(
                            myHomeScreenController
                                .GG1averageServicetimeController
                                .text),variance1:  int.parse(myHomeScreenController
                        .varianceArrivalControler
                        .text ),variance2:  int.parse(myHomeScreenController
                        .varianceServiceController
                        .text ),flag: "3");
                    myHomeScreenController.update();
                  },
                ...
                myHomeScreenController.gg1List.length==0?Text(""):
                GridView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemCount: myHomeScreenController.gg1List.length,
                  gridDelegate:
                            ...
                            axes: <RadialAxis>[
                              RadialAxis(minimum: 0, maximum: 100,
                                  ...
                                  pointers: <GaugePointer>[
                                    NeedlePointer(value: myHomeScreenController.gg1List[index],needleColor: Colors.white,   lengthUnit: GaugeSizeUnit.factor,
                                        needleLength: 0.6,
                                  ...
                                  annotations: <GaugeAnnotation>[
                                    GaugeAnnotation(
                                        widget:
                                        Container(child:
                                        Text(myHomeScreenController.gg1List[index].toStringAsFixed(3),
