          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    myHomeScreenController.mg1List.clear();
                    myHomeScreenController. update();
                    myHomeScreenController.MG1(
                        ...
                        maxaverageServiceTime: int.parse(
                            myHomeScreenController
                                .maxaverageServiceTimeController
                                .text),minaverageServiceTime:  int.parse(myHomeScreenController
                        .minaverageServiceTimeController
                        .text ),flag: "2");
                    myHomeScreenController.update();
                  },
                ...
                myHomeScreenController.mg1List.length==0?Text(""):
                GridView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemCount: myHomeScreenController.mg1List.length,
                  gridDelegate:
                            ...
                            axes: <RadialAxis>[
                              RadialAxis(minimum: 0, maximum: 100,
                                  ...
                                  pointers: <GaugePointer>[
                                    NeedlePointer(value: myHomeScreenController.mg1List[index],needleColor: Colors.white,   lengthUnit: GaugeSizeUnit.factor,
                                        needleLength: 0.6,
                                  ...
                                  annotations: <GaugeAnnotation>[
                                    GaugeAnnotation(
                                        widget:
                                        Container(child:
                                        Text(myHomeScreenController.mg1List[index].toStringAsFixed(3),
